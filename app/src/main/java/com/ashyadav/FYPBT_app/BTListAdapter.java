...
public class BTListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BTListAdapter(Context context, List<Object> deviceList) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        final BTInfoID deviceInfoModel = (BTInfoID) deviceList.get(position);
